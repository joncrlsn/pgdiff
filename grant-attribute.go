...
func (c *GrantAttributeSchema) Change(obj interface{}) {
	...
	if len(grantList) > 0 {
		fmt.Printf("GRANT %s (%q) ON %q.%q TO %s; -- Change\n", strings.Join(grantList, ", "),
